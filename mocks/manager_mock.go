...
func (m *MockDeploymentManager) SetWorkloads(workoads map[uint32][]gridtypes.Workload) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetWorkloads", workoads)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetWorkloads indicates an expected call of SetWorkloads.
func (mr *MockDeploymentManagerMockRecorder) SetWorkloads(workoads interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetWorkloads", reflect.TypeOf((*MockDeploymentManager)(nil).SetWorkloads), workoads)
}
